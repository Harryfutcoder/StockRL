...
Jump-Diffusion Model to account for sudden changes in the environment, providing a more robust 
framework for real-world applications. Experimental results demonstrate that BSMRL outperforms 
